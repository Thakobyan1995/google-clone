// if google api day limit is exceeded than you can uncomment line 8 && line 25 
//to see the results from mock api call
...
import DescripotionIcon from '@material-ui/icons/Description';
        ...
        <div className="searchPage">
            ...
            { term && (
                <div className="searchPage__results">
                    <p className="searchPahe_-resultCount">
